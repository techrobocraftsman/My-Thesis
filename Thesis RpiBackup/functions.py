...
def getContoure(img, output):
    ...
    for cnt in contours:
        ...
        if area > 500:
            ...
            cv2.circle(output, centroid, 2, (199, 0, 255), 2)
            cv2.putText(output, objectType, (x+(w//2)-10, y+(h//2)-10), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0, 0, 0), 2)
